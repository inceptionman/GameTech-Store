    ...
    with app.app_context():
        ...
        hardware_data = [
            ...
            # Motherboards
            {
                ...
                'precio': 129.99,
                'descripcion': 'Placa base ATX para AMD con soporte para Ryzen (socket AM4). Excelente para builds gaming de gama media.',
                'imagen': '/static/images/hardware/mb-asus-b450.jpg',
                'stock': 10,
                'especificaciones': json.dumps({
                    'socket': 'AM4',
                    'chipset': 'B450',
            ...
            },
            {
                ...
                'precio': 149.99,
                'descripcion': 'Placa base Intel (LGA1700) con soporte para CPUs 12ª/13ª generación y PCIe 4.0.',
                'imagen': '/static/images/hardware/mb-msi-b660.jpg',
                'stock': 12,
                'especificaciones': json.dumps({
                    'socket': 'LGA1700',
                    'chipset': 'B660',
